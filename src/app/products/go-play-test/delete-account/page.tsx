...
export const metadata: Metadata = {
  title: 'Delete Account - Go Play Test',
  description: 'Request account deletion for Go Play Test.',
}
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-red-50 dark:bg-red-900/20 rounded-xl flex items-center justify-center"><Trash2 className="w-6 h-6 text-red-500" /></div>
              <div>
                <p className="text-sm text-dark-500">{product.name}</p>
                <h1 className="text-3xl md:text-4xl font-bold text-dark-900 dark:text-white">Request Account Deletion</h1>
              </div>
            </div>
