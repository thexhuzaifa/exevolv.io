              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input 
                    ...
                    id="email" 
                    required 
                    className="w-full px-4 py-3 rounded-xl border border-dark-200 dark:border-dark-700 bg-white dark:bg-dark-950 focus:outline-none focus:ring-2 focus:ring-red-500" 
                    placeholder="Enter your registered email address" 
                  />
                </div>
                <div>
                  <label htmlFor="reason" className="block text-sm font-medium text-dark-700 dark:text-dark-300 mb-2">
